...
<div class="content-body">
    <main id="gestion-salles">
        ...
        <div class="form-container">
            ...
            <form id="ajout-salle-form" method="post" action="../Dashboard_Admin/ajout/ajout_salles.php">
        ...
        <script>
            function supprimerSalle(id) {
                if (confirm("Êtes-vous sûr de vouloir supprimer cette salle de classe ?")) {
                    ...
                    xhr.open("POST", "../Dashboard_Admin/supprimer/supprimer_salle.php", true);
            ...
            function chargerDonneesSalle(id) {
                ...
                xhr.onreadystatechange = function() {
                    if (xhr.readyState == 4 && xhr.status == 200) {
                        ...
                        if (!salle.error) {
                            ...
                            document.getElementById('ajout-salle-form').action = "../Dashboard_Admin/modifier/modifier_salles.php";
                ...
                xhr.open("GET", "../Dashboard_Admin/modifier/modifier_salle.php?id=" + id, true);
                xhr.send();
            }
            ...
            function effacerChamps() {
                ...
                document.getElementById('ajout-salle-form').action = "../Dashboard_Admin/ajout/ajout_salles.php";
