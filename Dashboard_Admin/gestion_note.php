...
<div class="content-body">
    <main id="gestion-notes">
        ...
        <div class="form-container">
            ...
            <form id="ajout-note-form" method="POST" action=".././Dashboard_Admin/ajout/ajout_note.php">
...
<script>
    function supprimerPersonnel(id) {
        if (confirm("Êtes-vous sûr de vouloir supprimer ce membre du personnel ?")) {
            ...
            xhr.open("POST", "../Dashboard_Admin/supprimer/supprimer_note.php", true);
    ...
    function chargerDonneesPersonnel(id) {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                if (!note.error) {
                    ...
                    document.getElementById('ajout-note-form').action = "../Dashboard_Admin/modifier/modifier_notes.php";
        ...
        xhr.open("POST", "../Dashboard_Admin/modifier/modifier_note.php?id=" + id, true);
        xhr.send();
    }
