...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $destinataire_id = $_POST['destinataire-id'];
    $message_content = $_POST['message'];
    $type_expediteur = "Admin"; // Par défaut, l'expéditeur est considéré comme un élève
...
header("Location: ../messagerie.php?message=" . urlencode($message));
