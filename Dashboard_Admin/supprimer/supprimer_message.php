...
if(isset($_POST['message_id'])) {
    ...
    if(mysqli_stmt_execute($stmt)) {
        ...
        header("Location: ../Dashboard_Admin/messagerie.php?message=succès : message supprimé avec succès");
        exit();
    } else {
        // Redirection vers la page précédente avec un message d'erreur
        header("Location: ../Dashboard_Admin/messagerie.php?message=erreur : échec de la suppression du message");
        exit();
    }
} else {
    // Redirection vers la page précédente avec un message d'erreur
    header("Location: ../Dashboard_Admin/messagerie.php?message=erreur : aucun message ID spécifié");
    exit();
}
?>
