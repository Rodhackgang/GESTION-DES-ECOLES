...
<div class="content-body">
    <main id="gestion-evaluations">
        ...
        <div class="form-container">
            ...
            <form id="ajout-evaluation-form" method="POST" action="../Dashboard_Admin/ajout/ajout_evaluation.php">
    ...
    function chargerDonneesEvaluation(id) {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                document.getElementById('ajout-evaluation-form').action = "../Dashboard_Admin/modifier/modifier_evaluations.php";
        ...
        xhr.open("GET", "../Dashboard_Admin/modifier/modifier_evaluation.php?id=" + id, true);
        xhr.send();
    }
