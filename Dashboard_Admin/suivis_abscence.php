...
<div class="form-container">
    ...
    <form id="ajout-absence-form" method="POST" action="../Dashboard_Admin/ajout/ajout_abscence.php">
...
<script>
    function supprimerAbsence(id) {
        if (confirm("Êtes-vous sûr de vouloir supprimer cette absence ?")) {
            ...
            xhr.open("POST", "../Dashboard_Admin/supprimer/supprimer_absence.php", true);
    ...
    function chargerDonneesAbsence(id) {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                if (!absence.error) {
                    ...
                    document.getElementById('ajout-absence-form').action = "../Dashboard_Admin/modifier/modifier_absence.php";
        ...
        xhr.open("GET", "../Dashboard_Admin/modifier/modifier_absence.php?id=" + id, true);
        xhr.send();
    }
    ...
    function effacerChamps() {
        ...
        document.getElementById('ajout-absence-form').action = "../Dashboard_Admin/ajout/ajout_absence.php";
