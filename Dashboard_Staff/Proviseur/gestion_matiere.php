...
<div class="form-container">
    ...
    <form id="ajout-matiere-form" method="post" action="../../Dashboard_Staff/Proviseur/ajout/ajout_matiere.php">
...
<script>
    ...
    function supprimerMatiere(id) {
        if (confirm("Êtes-vous sûr de vouloir supprimer cette matière ?")) {
            ...
            xhr.open("POST", "../../Dashboard_Staff/Proviseur/supprimer/supprimer_matiere.php", true);
    ...
    function chargerDonneesMatiere(id) {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                document.getElementById('ajout-matiere-form').action = "../../Dashboard_Staff/Proviseur/modifier/modifier_matieres.php";
        ...
        xhr.open("GET", "../../Dashboard_Staff/Proviseur/modifier/modifier_matiere.php?id=" + id, true);
        xhr.send();
    }
    ...
    function effacerChamps() {
        ...
        document.getElementById('ajout-matiere-form').action = "../../Dashboard_Staff/Proviseur/ajout/ajout_matiere.php";
