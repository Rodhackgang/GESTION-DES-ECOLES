...
if ($result->num_rows > 0) {
    ...
    header("Location: ../../Dashboard_Staff/Proviseur/gestion_eleves.php?error=email_exists");
    exit();
} else {
    ...
    if ($conn->query($sql_insert) === TRUE) {
        ...
        header("Location: ../../Dashboard_Staff/Proviseur/gestion_eleves.php?success=inserted");
        exit();
    } else {
        // Si l'insertion échoue, rediriger avec un message d'erreur
        header("Location: ../../Dashboard_Staff/Proviseur/gestion_eleves.php?error=insert_failed");
        exit();
    }
}
