        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                ...
                <p class="brand-title" width="124px" height="33px" style="font-size: 30px;">Proviseur</p>
            </a>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="../../../Dashboard_Staff/Proviseur/index.php" aria-expanded="false">
                            <i class="flaticon-025-dashboard"></i>
                            <span class="nav-text">Tableau de bord</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Proviseur/anne.php" aria-expanded="false">
                            <i class="flaticon-025-dashboard"></i>
                            <span class="nav-text">Gestion années</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Proviseur/gestion_eleves.php" aria-expanded="false">
                    ...
                    <li><a href="../../../Dashboard_Staff/Proviseur/gestion_matiere.php" aria-expanded="false">
                            <i class="flaticon-086-star"></i>
                            <span class="nav-text">Gestion Matières</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Proviseur/gestion_salle.php" aria-expanded="false">
                            <i class="flaticon-045-heart"></i>
                            <span class="nav-text">Gestion Salles</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Proviseur/gestion_attribution.php" aria-expanded="false">
                            <i class="flaticon-050-info"></i>
                            <span class="nav-text">Gestion des attributions</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Proviseur/gestion_note.php" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-013-checkmark"></i>
                            <span class="nav-text">Gestion des Notes</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Proviseur/gestions_emplois.php" aria-expanded="false">
                            <i class="flaticon-072-printer"></i>
                            <span class="nav-text">Gestion Emplois</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Proviseur/messagerie.php" aria-expanded="false">
                            <i class="flaticon-043-menu"></i>
                            <span class="nav-text">Messagerie</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Proviseur/gestion_evaluation.php" aria-expanded="false">
                            <i class="flaticon-022-copy"></i>
                            <span class="nav-text">Evaluations</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Proviseur/suivis_abscence.php" aria-expanded="false">
                            <i class="flaticon-022-copy"></i>
                            <span class="nav-text">Suivi des Absences</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Proviseur/gestion_bulletins.php" aria-expanded="false">
                            <i class="flaticon-022-copy"></i>
