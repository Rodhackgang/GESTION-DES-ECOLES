...
<div class="content-body">
    <main id="gestion-emplois">
        ...
        <div class="form-container">
            ...
            ?>
            <form id="ajout-emploi-form" method="POST" action="../../Dashboard_Staff/Proviseur/ajout/ajout_emplois.php">
    ...
    <div class="form-container">
        ...
        <form id="remplacement-form" method="POST" action="../../Dashboard_Staff/Proviseur/modifier/modifier_emplois.php">
...
<script>
    ...
    function deleteEmploi(id) {
        if (confirm("Êtes-vous sûr de vouloir supprimer cet emploi du temps ?")) {
            ...
            xhr.open("POST", "../../Dashboard_Staff/Proviseur/supprimer/supprimer_emplois.php", true);
