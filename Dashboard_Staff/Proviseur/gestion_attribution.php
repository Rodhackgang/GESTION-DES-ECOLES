...
<div class="form-container">
            ...
            <form id="attribution-salle-form" method="post" action="../../Dashboard_Staff/Proviseur/ajout/ajout_attribution.php">
        ...
        <script>
            function supprimerSalle(id) {
                if (confirm("Êtes-vous sûr de vouloir supprimer cette salle de classe ?")) {
                    ...
                    xhr.open("POST", "../../Dashboard_Staff/Proviseur/supprimer/supprimer_attribution.php", true);
            ...
            function chargerDonneesSalle(id) {
                ...
                xhr.onreadystatechange = function() {
                    if (xhr.readyState == 4 && xhr.status == 200) {
                        ...
                        if (!salle.error) {
                            ...
                            document.getElementById('attribution-salle-form').action = "../../Dashboard_Staff/Proviseur/modifier/modifier_attributions.php";
                ...
                xhr.open("GET", "../../Dashboard_Staff/Proviseur/modifier/modifier_attribution.php?id=" + id, true);
                xhr.send();
            }
            ...
            function effacerChamps() {
                ...
                document.getElementById('attribution-salle-form').action = "../../Dashboard_Staff/Proviseur/ajout/ajout_attribution.php";
