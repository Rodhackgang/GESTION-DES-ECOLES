...
<div class="content-body">
    ...
    <form id="ajout-eleve-form" method="POST" action="../../Dashboard_Staff/Proviseur/ajout/ajout_eleves.php">
    ...
    <script>
        ...
        function supprimerEleve(id) {
            if (confirm("Êtes-vous sûr de vouloir supprimer cet élève ?")) {
                ...
                xhr.open("POST", "../../Dashboard_Staff/Proviseur/supprimer/supprimer.php", true);
        ...
        function chargerDonneesEleve(id) {
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    document.getElementById('ajout-eleve-form').action = "../../Dashboard_Staff/Proviseur/modifier/modifier_eleves.php";
            ...
            xhr.open("GET", "../../Dashboard_Staff/Proviseur/modifier/modifier_eleve.php?id=" + id, true);
            xhr.send();
        }
        ...
        function effacerChamps() {
            ...
            document.getElementById('ajout-eleve-form').action = "../../Dashboard_Staff/Proviseur/ajout/ajout_eleves.php";
