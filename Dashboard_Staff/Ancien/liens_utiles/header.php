    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="../../Dasboard_Staff/staffs_dashboard.php" class="brand-logo">
                ...
                <p class="brand-title" width="124px" height="33px" style="font-size: 30px;">Staffs</p>
            </a>
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item">
                                <a href="javascript:void(0);" class="btn btn-primary d-sm-inline-block d-none">Gestins des Staffs<i class="las la-signal ms-3 scale5"></i></a>
                            </li>
                        </ul>
                    </div>
                </nav>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="../../Dashboard_Staff/staff_dashboard.php" aria-expanded="false">
                            <i class="flaticon-025-dashboard"></i>
                            <span class="nav-text">Acceuil</span>
                        </a>
                    </li>
                    <li><a href="../../Dashboard_Staff/profile.php" aria-expanded="false">
                            <i class="flaticon-050-info"></i>
                            <span class="nav-text">Profil</span>
                        </a>
                    </li>
                    
                    <li><a href="../../Dashboard_Staff/emplois.php" aria-expanded="false">
                            <i class="flaticon-086-star"></i>
                            <span class="nav-text">Emploi du temps</span>
                        </a>
                    </li>
                    <li><a href="../../Dashboard_Staff/abscences.php" aria-expanded="false">
                            <i class="flaticon-045-heart"></i>
                            <span class="nav-text">Absences</span>
                        </a>
                    </li>
                    <li><a href="../../Dashboard_Staff/bulletins.php" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-013-checkmark"></i>
                            <span class="nav-text">Bulletins de notes</span>
                        </a>
                    </li>
                    <li><a href="../../Dashboard_Staff/messages.php" aria-expanded="false">
