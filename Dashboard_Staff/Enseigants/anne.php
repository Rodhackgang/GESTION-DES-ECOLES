...
<div class="content-body">
        <div class="container">
            ...
            <form id="ajout-annee-scolaire-form" method="POST" action="../Enseigants/ajout/ajout_anne.php">
                   ...
                   $result = $conn->query("SELECT * FROM annees_scolaires");
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>";
                            echo "<form method='POST' action='../Enseigants/ajout/ajout_anne.php' class='inline-form'>";
