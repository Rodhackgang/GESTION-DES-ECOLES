        ...
        ***********************************-->
        <div class="nav-header">
            <a class="brand-logo">
                ...
                <p class="brand-title" width="124px" height="33px" style="font-size: 30px;">Enseigants</p>
            </a>
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item">
                                <a href="javascript:void(0);" class="btn btn-primary d-sm-inline-block d-none">Enseigants Dashboard<i class="las la-signal ms-3 scale5"></i></a>
                            </li>
                        </ul>
                    </div>
                </nav>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="../../../Dashboard_Staff/Enseigants/index.php" aria-expanded="false">
                            <i class="flaticon-025-dashboard"></i>
                            <span class="nav-text">Tableau de bord</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Enseigants/anne.php" aria-expanded="false">
                            <i class="flaticon-025-dashboard"></i>
                    ...
                    <li><a href="../../../Dashboard_Staff/Enseigants/gestion_salle.php" aria-expanded="false">
                            <i class="flaticon-045-heart"></i>
                            <span class="nav-text">Gestion Salles</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Enseigants/gestion_note.php" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-013-checkmark"></i>
                            <span class="nav-text">Gestion des Notes</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Enseigants/gestions_emplois.php" aria-expanded="false">
                            <i class="flaticon-072-printer"></i>
                            <span class="nav-text">Gestion Emplois</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Enseigants/messagerie.php" aria-expanded="false">
                            <i class="flaticon-043-menu"></i>
                            <span class="nav-text">Messagerie</span>
                        </a>
                    </li>
                    
                    <li><a href="../../../Dashboard_Staff/Enseigants/suivis_abscence.php" aria-expanded="false">
                            <i class="flaticon-022-copy"></i>
                            <span class="nav-text">Suivi des Absences</span>
                        </a>
                    </li>
                    <li><a href="../../../Dashboard_Staff/Enseigants/gestion_bulletins.php" aria-expanded="false">
                            <i class="flaticon-022-copy"></i>
