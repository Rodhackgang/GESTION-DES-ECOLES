...
<div class="content-body">
    <main id="gestion-notes">
        ...
        <div class="form-container">
            ...
            <form id="ajout-note-form" method="POST" action=".././Enseigants/ajout/ajout_note.php">
...
<script>
    function supprimerPersonnel(id) {
        if (confirm("Êtes-vous sûr de vouloir supprimer ce membre du personnel ?")) {
            ...
            xhr.open("POST", "../Dashboard_Staff/Enseigants/supprimer/supprimer_note.php", true);
    ...
    function chargerDonneesPersonnel(id) {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                if (!note.error) {
                    ...
                    document.getElementById('ajout-note-form').action = "../Dashboard_Staff/Enseigants/modifier/modifier_notes.php";
        ...
        xhr.open("POST", "../Dashboard_Staff/Enseigants/modifier/modifier_note.php?id=" + id, true);
        xhr.send();
    }
    ...
    function effacerChamps() {
        ...
        document.getElementById('ajout-personnel-form').action = "../Dashboard_Staff/Enseigants/ajout/ajout_personnel.php";
