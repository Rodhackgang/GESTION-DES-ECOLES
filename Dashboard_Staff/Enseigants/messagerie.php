...
echo '<form id="envoi-message-form" method="POST" action="../../Dashboard_Staff/Enseigants/ajout/ajout_messagerie_admin.php">';
...
echo '}';
echo '};';
echo 'xhr.open(\'POST\', \'../Dashboard_Staff/Enseigants/supprimer/supprimer_message.php\');';
