...
<style>
        .dlabnav-scroll {
            max-height: 900px; /* Hauteur maximale du menu avant d'activer le scroll */
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="../../Dasboard_Eleves/eleve_dashboard.php" class="brand-logo">
                ...
                <p class="brand-title" width="124px" height="33px" style="font-size: 30px;">Eleves</p>
            </a>
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item">
                                <a href="javascript:void(0);" class="btn btn-primary d-sm-inline-block d-none">Gestins des eleves<i class="las la-signal ms-3 scale5"></i></a>
                            </li>
                        </ul>
                    </div>
                </nav>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="../../Dasboard_Eleves/eleve_dashboard.php" aria-expanded="false">
                            <i class="flaticon-025-dashboard"></i>
                            <span class="nav-text">Acceuil</span>
                        </a>
                    </li>
                    <li><a href="../../Dasboard_Eleves/profile.php" aria-expanded="false">
                            <i class="flaticon-050-info"></i>
                            <span class="nav-text">Profil</span>
                        </a>
                    </li>
                    <li><a href="../../Dasboard_Eleves/note.php" aria-expanded="false">
                            <i class="flaticon-041-graph"></i>
                            <span class="nav-text">Notes</span>
                        </a>
                    </li>
                    <li><a href="../../Dasboard_Eleves/emplois.php" aria-expanded="false">
                            <i class="flaticon-086-star"></i>
                            <span class="nav-text">Emploi du temps</span>
                        </a>
                    </li>
                    <li><a href="../../Dasboard_Eleves/abscences.php" aria-expanded="false">
                            <i class="flaticon-045-heart"></i>
                            <span class="nav-text">Absences</span>
                        </a>
                    </li>
                    <li><a href="../../Dasboard_Eleves/bulletins.php" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-013-checkmark"></i>
                            <span class="nav-text">Bulletins de notes</span>
                        </a>
                    </li>
                    <li><a href="../../Dasboard_Eleves/messages.php" aria-expanded="false">
